...
/*   Updated: 2025/05/17 16:03:13 by qbarron          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int ft_minilibx_init(t_game *game_st)
{
	...
	if(!game_st->mlx_struct.mlx_windows)
		return(-1);
	game_st->mlx_struct.mlx_img = mlx_new_image(game_st->mlx_struct.mlx_init, game_st->mlx_struct.win_w, game_st->mlx_struct.win_h);
